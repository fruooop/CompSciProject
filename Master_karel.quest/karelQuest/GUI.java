...
public class GUI {
	...
	public static void main(String[] args) {
		...
		int gWidth = ((UpdateQue.getFloor().getHeight()*blockScale) + UpdateQue.getFloor().getWidth()+blockScale)+20; //Fancy math for calculating gameWindow Widths
		//---------------------------------------------------------//
